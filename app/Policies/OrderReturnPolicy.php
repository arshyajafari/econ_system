...
class OrderReturnPolicy
{
    ...
    public function view(User $user, OrderReturn $orderReturn): bool { return $this->isAdmin($user) || $this->isAccountant($user) || ($user->can('order_returns.view') && $this->ownsReturn($user, $orderReturn)); }
