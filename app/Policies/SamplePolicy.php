...
class SamplePolicy {
    ...
    public function view(User $user, Sample $sample): bool { return $this->isScientificVisitor($user) || $user->can('samples.view'); }
    public function create(User $user): bool { return $this->isScientificVisitor($user) || $user->can('samples.create'); }
    public function update(User $user, Sample $sample): bool { return $this->isScientificVisitor($user) || $user->can('samples.update'); }
    public function delete(User $user, Sample $sample): bool { return $user->hasRole('admin') || $user->can('samples.delete'); }
