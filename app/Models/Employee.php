...
class Employee extends BaseModel implements HasGeneratedCode {
    ...
    protected $fillable = [
        'code', 'first_name', 'last_name', 'national_code', 'phone_number', 'social_link', 'email',
        'gender', 'birth_date', 'card_number', 'iban_number', 'employment_type', 'activity_type',
        'hire_date', 'termination_date', 'status', 'description', 'meta',
    ];
    ...
    protected function casts(): array {
        return array_merge(parent::casts(), [
            ...
            'activity_type' => EmployeeActivityType::class,
            'birth_date' => 'date',
            'hire_date' => 'date',
    ...
    public function scopeActive(Builder $query): Builder { return $query->where('status', EmployeeStatus::ACTIVE->value); }
    public function scopeInactive(Builder $query): Builder { return $query->where('status', EmployeeStatus::INACTIVE->value); }
    ...
    public static function codeGenerator(): CodeGeneratorData { return new CodeGeneratorData(sequence_key: 'employee', prefix: 'EMP', padding: 6); }
}
