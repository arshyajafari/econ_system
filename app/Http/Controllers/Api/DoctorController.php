...
class DoctorController extends Controller
{
    ...
    public function index(DoctorIndexRequest $request, ListDoctorsAction $action): AnonymousResourceCollection
    {
        $this->authorize('viewAny', Doctor::class);

        return DoctorResource::collection($action->execute($request->validated()));
    }
    ...
    public function update(UpdateDoctorRequest $request, Doctor $doctor, UpdateDoctorAction $action): DoctorResource
    {
    ...
    public function changeStatus(ChangeDoctorStatusRequest $request, Doctor $doctor, ChangeDoctorStatusAction $action): DoctorResource
    {
