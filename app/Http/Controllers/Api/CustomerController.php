...
class CustomerController extends Controller
{
    ...
    public function index(CustomerIndexRequest $request, ListCustomersAction $action): AnonymousResourceCollection
    {
        return CustomerResource::collection($action->execute($request->validated()));
    }
    ...
    public function changeStatus(ChangeCustomerStatusRequest $request, Customer $customer, ChangeCustomerStatusAction $action): CustomerResource
    {
